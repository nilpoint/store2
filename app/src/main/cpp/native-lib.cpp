...
JNIEXPORT jint JNICALL Java_cn_topca_store2_StoreActivity_getCount
        (JNIEnv* pEnv, jobject pObject) {
    return gStore.mLength;
}

JNIEXPORT jstring JNICALL Java_cn_topca_store2_StoreActivity_getString
...
JNIEXPORT void JNICALL Java_cn_topca_store2_StoreActivity_setString
